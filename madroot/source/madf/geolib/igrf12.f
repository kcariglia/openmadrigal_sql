C      PROGRAM IGRF12
C
C     As imported unchanged by Bill Rideout from http://www.ngdc.noaa.gov/IAGA/vmod/igrf12.f
C     on Aug. 17, 2016 for use in Madrigal 3.0 release.
C
C     $Id: igrf12.f 5773 2016-08-18 18:45:05Z brideout $
C
C     Bill Rideout editted out main program; commented out 2020-2025 warning
C
