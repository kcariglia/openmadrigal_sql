...
$Id: isprintExe.py 7043 2019-10-07 19:10:59Z brideout $
"""
...
class MadrigalIsprintExe:
    ...
    def getModifiedIsprintString(self,
        ...
        isFirstRec = 1
        cycList = list(range(0, maddata[1]))
        recNumList = maddata[2]
        
        for cycNum in cycList:

            # loop through each record
            recList = list(range(0, recNumList[cycNum]))
            for recNum in recList:
                ...
                lineNumList = list(range(0, len(lineList)))
                acceptList = []
