...
$Id: report.py 7043 2019-10-07 19:10:59Z brideout $
"""
import pickle
import os, sys, stat
import time
...
class MadrigalReport:
    ...
    def looker(self,
        ...
        # get ut
        ut = madrigal.metadata.getMadrigalUTFromDate(year,month,day,hour,min,sec,0)
    ...
    def looker2(self,
        ...
        It is similar to looker, but it does not use a grid of lat, lon, and alts.  Instead, each input
        point is independent. Also, it allows users to set both 1D and 2D parameters.
        ...
        Inputs:
            ...
            twoDParmValues - a python list of lists of len = len(twoDParmList). Each individual 
                             ...
                             of points (or equal to len(lats)).
                             Defaults to [].
        ...
        # call looker_nonFile
        madrigal._Madrec.looker2_nonFile(list(parmList),
                                         list(lats),
                                         list(longs),
                                         list(alts),
                                         float(ut),
