...
*
*     $Id: _derive.c 7580 2023-08-15 15:11:06Z brideout $
*/
...
static PyObject * _derive_madDispatch(PyObject * self, PyObject * args)
{
    ...
    if (strcmp(methodName, "getPrologTime")==0)
        getPrologTime(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getByear")==0)
        getByear(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getTime")==0)
        getTime(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getBmd")==0)
        getBmd(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getBMonthDay")==0)
        getBMonthDay(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getMd")==0)
        getMd(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getUtUnix")==0)
        getUtUnix(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getDayno")==0)
        getDayno(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getBhm")==0)
        getBhm(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getBhhmmss")==0)
        getBhhmmss(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getEhhmmss")==0)
        getEhhmmss(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getHm")==0)
        getHm(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getUth")==0)
        getUth(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getUts")==0)
        getUts(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getBUth")==0)
        getBUth(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getInttms")==0)
        getInttms(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getInttmm")==0)
        getInttmm(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getDatntd")==0)
        getDatntd(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getUt")==0)
        getUt(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getBegUt")==0)
        getBegUt(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getJdayno")==0)
        getJdayno(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getJulian_date")==0)
        getJulian_date(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getJulian_day")==0)
        getJulian_day(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getUt1")==0)
        getUt1(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getUt2")==0)
        getUt2(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getDut21")==0)
        getDut21(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getFyear")==0)
        getFyear(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getAltInc")==0)
        getAltInc(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getAveAlt")==0)
        getAveAlt(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getAveDAlt")==0)
        getAveDAlt(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getResl")==0)
        getResl(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getAzmDaz")==0)
        getAzmDaz(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getDAzmDDaz")==0)
        getDAzmDDaz(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getElmDel")==0)
        getElmDel(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getDElmDDel")==0)
        getDElmDDel(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getGeod")==0)
        getGeod(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getDGeod")==0)
        getDGeod(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getGeodGdalt")==0)
        getGeodGdalt(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getGeodAlt")==0)
        getGeodAlt(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getAzElRange")==0)
        getAzElRange(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getSZen")==0)
        getSZen(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getSltmut")==0)
        getSltmut(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getSlt")==0)
        getSlt(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getSdwHt")==0)
        getSdwHt(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getSuntime")==0)
        getSuntime(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getTecGdalt")==0)
        getTecGdalt(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getGcdist")==0)
        getGcdist(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getMag")==0)
        getMag(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getMag2")==0)
        getMag2(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getMagStat")==0)
        getMagStat(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getSltc")==0)
        getSltc(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getAplt")==0)
        getAplt(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getSZenc")==0)
        getSZenc(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getConjSun")==0)
        getConjSun(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getEregion")==0)
        getEregion(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getAspect")==0)
        getAspect(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getPopl")==0)
        getPopl(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getPop")==0)
        getPop(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getNel")==0)
        getNel(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getNe")==0)
        getNe(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getDNel")==0)
        getDNel(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getDNe")==0)
        getDNe(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getNemaxl")==0)
        getNemaxl(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getNemax")==0)
        getNemax(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getTr")==0)
        getTr(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getTe")==0)
        getTe(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getTi")==0)
        getTi(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getDteCctitr")==0)
        getDteCctitr(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getDte")==0)
        getDte(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getCol")==0)
        getCol(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getCo")==0)
        getCo(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getNeNel")==0)
        getNeNel(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getDNeDNel")==0)
        getDNeDNel(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getVisrNeDiff")==0)
        getVisrNeDiff(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getVisrNelDiff")==0)
        getVisrNelDiff(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getVisrTeDiff")==0)
        getVisrTeDiff(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getVisrTiDiff")==0)
        getVisrTiDiff(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getVisrVoDiff")==0)
        getVisrVoDiff(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getSn")==0)
        getSn(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getSnp3")==0)
        getSnp3(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getChip31")==0)
        getChip31(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getWchsq1")==0)
        getWchsq1(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getChisq1")==0)
        getChisq1(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getChip32")==0)
        getChip32(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getWchsq2")==0)
        getWchsq2(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getChisq2")==0)
        getChisq2(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getVi1Vi1f")==0)
        getVi1Vi1f(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getVi2Vi2f")==0)
        getVi2Vi2f(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getVipeVipe1")==0)
        getVipeVipe1(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getVipeVipe2")==0)
        getVipeVipe2(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getVipnVipn1")==0)
        getVipnVipn1(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getVipnVipn2")==0)
        getVipnVipn2(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getVi6Vipu")==0)
        getVi6Vipu(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getViGeom")==0)
        getViGeom(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getViGeod")==0)
        getViGeod(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getVn1Vn1p2")==0)
        getVn1Vn1p2(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getVn2Vn2p2")==0)
        getVn2Vn2p2(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getVnGeom")==0)
        getVnGeom(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getVnGeod")==0)
        getVnGeod(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getEFGeom")==0)
        getEFGeom(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getEFGeod")==0)
        getEFGeod(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getJGeom")==0)
        getJGeom(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getJGeod")==0)
        getJGeod(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getTn")==0)
        getTn(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getTnNoPhp")==0)
        getTnNoPhp(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getDTn")==0)
        getDTn(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getCond")==0)
        getCond(inLen, inValues, outLen, outValues, stderr);
    
    else if (strcmp(methodName, "getDCond")==0)
        getDCond(inLen, inValues, outLen, outValues, stderr);
