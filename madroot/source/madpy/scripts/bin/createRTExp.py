...
#$Id: createRTExp.py 7436 2022-05-16 17:45:06Z brideout $
...
Optional argument::
    ...
    --allowNonHdf5 - set if you want to allow filenames without Hdf5 extension (used rarely)
